...
export const BannerCarousel = () => {
  ...
  const activeBanners = bannerData.banners.filter((banner: BannerItem) => banner.isActive !== false);
  if (activeBanners.length === 0) return null;

  const currentBanner = activeBanners[currentIndex % activeBanners.length] as BannerItem;
