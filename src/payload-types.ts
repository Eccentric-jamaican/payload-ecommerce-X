...
export interface Category {
  ...
  name: string;
  /**
   * Used in URLs and filters (e.g. diagnostic-equipment).
   */
  slug: string;
  description?: string | null;
  updatedAt: string;
...
export interface ClinicalArea {
  ...
  name: string;
  /**
   * Used in filters (e.g. maternal-health).
   */
  slug: string;
  description?: string | null;
  updatedAt: string;
...
export interface BlogTopic {
  ...
  title: string;
  /**
   * Used in URLs and filters (e.g. supply-chain).
   */
  slug: string;
  updatedAt: string;
  createdAt: string;
...
export interface Blog {
  ...
  excerpt: string;
  /**
   * Tag this article with relevant topics to power filtering.
   */
  topics?: (string | BlogTopic)[] | null;
  content: {
    root: {
      type: string;
      children: {
...
export interface Product {
  ...
  /**
   * Shown on product cards and listings. Keep under 180 characters.
   */
  shortDescription?: string | null;
  /**
   * Full product narrative. Supports headings, lists, quotes, and media.
   */
  description?: {
    root: {
      type: string;
  ...
  /**
   * Upload imagery that showcases the product.
   */
  mediaGallery: {
    asset: string | Media;
    caption?: string | null;
  ...
  /**
   * Optional YouTube link that will be embedded on the product page.
   */
...
export interface SiteSetting {
  ...
  /**
   * Links rendered below the hero copy (e.g. Instagram, LinkedIn).
   */
  blogSocialLinks?:
    | {
